                    ...
                    if "state" in params:
                        try:
                            ...
                            if route in state_data:
                                ...
                                print_warning("  ⚠ State parameter doesn't contain target route")
        ...
        if response.status_code == 200:
            ...
            for css_file in css_matches:
                ...
                if asset_response.status_code == 200:
                    print_success("  ✓ CSS asset accessible")
                else:
            ...
            for js_file in js_matches:
                ...
                asset_response = requests.get(asset_url)
                if asset_response.status_code == 200:
                    print_success("  ✓ JS asset accessible")
                else:
                    print_error(f"  ✗ JS asset returns {asset_response.status_code}")

        else:
            print_error("✗ Could not get main page to find assets")
